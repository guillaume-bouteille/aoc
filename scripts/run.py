...
if __name__ == "__main__":
    ...
    exos = [
        ...
        Exo(root_dir, year=2024, day=2),
        Exo(root_dir, year=2024, day=3),
        Exo(root_dir, year=2024, day=4),
        Exo(root_dir, year=2024, day=5),
        Exo(root_dir, year=2024, day=6),
        Exo(root_dir, year=2024, day=7),
        Exo(root_dir, year=2024, day=8),
        Exo(root_dir, year=2024, day=9),
        Exo(root_dir, year=2024, day=10),
    ]
    res = []
